        ...
        {ruta ? (
         ...
         <View style={tw`flex-row items-center mx-6 mb-4`}>
            ...
            <View style={tw`m-4 mb-6 bg-black rounded-lg`}>
                <Text style={tw`text-base text-primary p-4 text-center`}>Toma una foto en cada parada y podrás ganar increibles... {"\n"}¡Premios y descuentos!</Text>
            </View>

            <Text style={tw`mx-6 text-lg`}>Información</Text>
            <Text style={tw`mx-6 mt-2 mb-6 text-base`}>{ruta.descripcion} Sed ut perspiciatis unde omnis iste natus error
              sit voluptatem accusantium doloremque laudantium, totam rem
              aperiam, eaque ipsa quae ab illo inventore veritatis et quasi
              architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam
              voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed</Text>
